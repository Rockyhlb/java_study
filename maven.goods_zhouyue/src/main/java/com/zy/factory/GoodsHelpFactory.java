            ...
            try {
                ...
                if(rs!=null){
                    ...
                    while (rs.next()) {
                        ...
                        Date add_time = rs.getDate("add_time");

                        System.out.println(goods_id + "\t\t" + type + "\t" + name + "\t\t" + price + "\t" + num + " \t" + add_time);
                    }
                }
                else {
                    System.out.println("数据库中无商品信息...");
                }
            }
            catch (SQLException e){
