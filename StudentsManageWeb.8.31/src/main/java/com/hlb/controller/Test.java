...
import com.hlb.biz.LinuxHelpFactory;
import com.hlb.biz.MysqlHelpFactory;
            ...
            switch (choice){
                case 1:
                    ...
                    while (mysql_flag) {
                        System.out.println();
                        System.out.println("**************************************************");
                        System.out.println("****  正在使用Windows + mysql 学生信息管理系统  ****");
                ...
                case 2:
                    ...
                    boolean Linux_flag = linuxHelpFactory.connect(linux_host,linux_userName,linux_passWd,linux_dataBase);

                    while (Linux_flag) {
                        System.out.println();
                        System.out.println("*******************************************************");
                        System.out.println("****   正在使用Linux + mysql数据库 学生成绩管理系统  ****");
                        System.out.println("***********      1        录 入 成 绩    **************");
                        System.out.println("***********      2        删 除 成 绩    **************");
                        System.out.println("***********      3        查 询 成 绩    **************");
                        System.out.println("***********      4        修 改 成 绩    **************");
                        System.out.println("***********      0        退       出    **************");
                        System.out.println("*******************************************************");
                        int dataProcess = -1;
                        try {
                        ...
                        switch (dataProcess){
                            case 1:
                                try {
                                    // 每次factory进行增删查改操作以后都会断开连接，因此要重新获取连接
                                    linuxHelpFactory.connect(linux_host,linux_userName,linux_passWd,linux_dataBase);
                            ...
                            case 3:
                                try {
                                    linuxHelpFactory.connect(linux_host,linux_userName,linux_passWd,linux_dataBase);
                                    String sql = "select * from students_score;";
