...
import code.hlb.entity.AEntity;
...
public interface IDao {
    ...
    void add(JdbcFactory jdbcFactory);
    void delete(JdbcFactory jdbcFactory);
    void select(JdbcFactory jdbcFactory) throws SQLException;
    void update(JdbcFactory jdbcFactory);
}
